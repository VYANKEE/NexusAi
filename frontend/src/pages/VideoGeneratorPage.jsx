    ...
    <div className="p-4 md:p-8 text-white">
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row gap-4">
          <textarea
            placeholder="Video generation is coming soon..."
            rows={3}
      ...
      <div className="w-full aspect-video bg-gray-800/50 rounded-lg border border-dashed border-gray-600 flex flex-col items-center justify-center text-center p-8">
         ...
         <p className="text-gray-500 mt-2 max-w-md">Our text-to-video engine is being upgraded. This feature will be available shortly. Stay tuned!</p>
      </div>
    </div>
  );
};
